...
This project is a simple calculator app built using Flutter. 
The app allows users to perform basic arithmetic calculations such as addition, subtraction, multiplication, and division.
...
command:
git clone https://github.com/sajadflutter/calculator_application.git
